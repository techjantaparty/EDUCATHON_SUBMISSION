...
export default function Header() {
    ...
    const connectWallet = async () => {
        ...
        try {
            ...
            const sepoliaNetworkId = "1320";

            if (chainId.toString() !== sepoliaNetworkId) {
                toast('Please Switch To AIA Testnet',
                    {
                        icon: '❌',
                        style: {
                            borderRadius: '40px',
    ...
    return (
        <div className="absolute inset-0 -z-10 h-screen w-screen items-center [background:radial-gradient(125%_125%_at_50%_10%,#000_40%,#63e_100%)]">
            <div className="min-h-screen w-screen flex items-center justify-center">
                <button onClick={connectWallet} type="button" className="text-gray-900 bg-white hover:bg-gray-100 border border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-600 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:bg-gray-700 me-2 mb-2">
